...
description: "When Rechtsprechungsradar: Nachtragsverteilung, SCHUFA und Neustart in Insolvency and Restructuring is required: organises facts, norm, burden of proof, counter-arguments, and next step; produces an interface map with conflict, jurisdiction, and evidence questions."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Rechtsprechungsradar Nachtragsverteilung Schufa Neustart"
  mike-type: "assistant"
