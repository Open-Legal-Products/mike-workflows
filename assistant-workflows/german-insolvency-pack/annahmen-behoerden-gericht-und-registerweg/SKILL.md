...
description: "When Annahmen: Behörden-, Gerichts- oder Registerweg in Insolvency and Restructuring is required: checks deadline, form, jurisdiction, legal remedy, and immediate measures; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Annahmen Behoerden Gericht Und Registerweg"
  mike-type: "assistant"
