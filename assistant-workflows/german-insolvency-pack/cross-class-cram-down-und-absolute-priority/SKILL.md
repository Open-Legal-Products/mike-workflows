...
description: "When Cross-Class-Cram-Down und Absolute Priority — Paragraf 26 StaRUG in Insolvency and Restructuring is required: checks deadline, form, jurisdiction, legal remedy, and immediate measures; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Cross Class Cram Down Und Absolute Priority"
  mike-type: "assistant"
