---
name: "fbp-kaltstart-interview"
description: "When /fortbestehensprognose:fortbestehensprognose-kaltstart-interview in Insolvency and Restructuring is required: clarifies role, objective, deadline, documents, and the appropriate next specialist workflow; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Fbp Kaltstart Interview"
  mike-type: "assistant"
...
1. Datei `~/.skills/plugins/config/claude-fuer-deutsches-recht/fortbestehensprognose/CLAUDE.md` prüfen.
