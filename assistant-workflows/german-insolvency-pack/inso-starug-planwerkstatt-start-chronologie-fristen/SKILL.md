...
description: "When Insolvenzplan und StaRUG-Planwerkstatt — Allgemein in Insolvency and Restructuring is required: checks deadline, form, jurisdiction, legal remedy, and immediate measures; produces a chronology with evidence matrix and objection list."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Inso Starug Planwerkstatt Start Chronologie Fristen"
  mike-type: "assistant"
