...
description: "When Red Team Obliegenheiten in Insolvency and Restructuring is required: drafts the appropriate document from facts, norm, evidence, and motion; produces a counter-check with error, evidence, and deadline review."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Red Team Obliegenheiten"
  mike-type: "assistant"
