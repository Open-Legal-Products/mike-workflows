...
description: "When Insolvenzantragspflicht — Paragraf 15a InsO und die Drei-Wochen-Frist in Insolvency and Restructuring is required: drafts the appropriate document from facts, norm, evidence, and motion; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Insolvenzantragspflicht Paragraph 15a Inso Und Drei Wochen Frist"
  mike-type: "assistant"
