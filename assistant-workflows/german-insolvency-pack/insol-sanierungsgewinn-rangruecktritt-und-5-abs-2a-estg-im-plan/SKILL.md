...
description: "When Sanierungsgewinn — Rangruecktritt und Paragraph 5 Absatz 2a EStG im Plan in Insolvency and Restructuring is required: checks deadline, form, jurisdiction, legal remedy, and immediate measures; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Insol Sanierungsgewinn Rangruecktritt Und 5 Abs 2a Estg Im Plan"
  mike-type: "assistant"
