...
description: "When IV Cross-Border Assets — Trustee, DIP, Registervollzug in Insolvency and Restructuring is required: organises facts, norm, burden of proof, counter-arguments, and next step; produces a filing plan with form, portal, and evidence check."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Cross Iv Eigenverwaltung"
  mike-type: "assistant"
