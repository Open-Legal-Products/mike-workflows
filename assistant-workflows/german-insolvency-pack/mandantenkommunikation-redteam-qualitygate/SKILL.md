...
description: "When Liquiditätskommunikation Red-Team und Quality-Gate in Insolvency and Restructuring is required: decomposes outcome, deadline, jurisdiction, burden of proof, and opposing position; produces a counter-check with error, evidence, and deadline review."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Mandantenkommunikation Redteam Qualitygate"
  mike-type: "assistant"
