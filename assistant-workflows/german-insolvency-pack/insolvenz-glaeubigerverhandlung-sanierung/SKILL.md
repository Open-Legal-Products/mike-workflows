...
description: "When Sanierungs-Verhandlung mit Gläubigern vor und in Insolvency and Restructuring is required: develops negotiation objective, settlement corridor, and escalation path; produces a negotiation or escalation line with options."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Insolvenz Glaeubigerverhandlung Sanierung"
  mike-type: "assistant"
