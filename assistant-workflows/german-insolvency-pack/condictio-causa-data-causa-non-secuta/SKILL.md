...
description: "When Causa data causa non secuta in Restitution and Avoidance Law is required: calculates thresholds, amounts, variants, and control assumptions; liefert eine Berechnungstabelle mit Schwellen, Annahmen und Kontrollfragen. Auswahlstichwort: Condictio Causa Data Causa Non Secuta; Arbeitsfeld: bereicherungs-und-anfechtungsrecht-prüfer."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Condictio Causa Data Causa Non Secuta"
  mike-type: "assistant"
