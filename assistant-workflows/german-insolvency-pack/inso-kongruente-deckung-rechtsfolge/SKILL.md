...
description: "When Kongruente Deckung — Paragraf 130 InsO in Restitution and Avoidance Law is required: drafts the appropriate document from facts, norm, evidence, and motion; liefert einen verwertbaren Entwurf mit Anträgen, Begründung und Anlagenlogik. Auswahlstichwort: Inso Kongruente Deckung Rechtsfolge; Arbeitsfeld: bereicherungs-und-anfechtungsrecht-prüfer."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Inso Kongruente Deckung Rechtsfolge"
  mike-type: "assistant"
