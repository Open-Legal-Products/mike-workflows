...
description: "When Klagewerkstatt: Erstprüfung, Rollenklärung und Mandatsziel in Insolvency and Restructuring is required: clarifies role, objective, deadline, documents, and the appropriate next specialist workflow; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Spezial Klagewerkstatt Erstpruefung Und Mandatsziel"
  mike-type: "assistant"
