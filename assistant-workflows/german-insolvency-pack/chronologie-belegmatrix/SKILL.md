...
description: "When Chronologie und Belegmatrix in Insolvency and Restructuring is required: drafts the appropriate document from facts, norm, evidence, and motion; produces a chronology with evidence matrix and objection list."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Chronologie Belegmatrix"
  mike-type: "assistant"
