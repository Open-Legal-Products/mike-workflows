...
description: "When Verschärfte Haftung — Paragraf 819 BGB bei Bösgläubigkeit in Restitution and Avoidance Law is required: calculates thresholds, amounts, variants, and control assumptions; liefert eine Berechnungstabelle mit Schwellen, Annahmen und Kontrollfragen. Auswahlstichwort: Verschaerfte Haftung 819 BGB Bosglaeubigkeit; Arbeitsfeld: bereicherungs-und-anfechtungsrecht-prüfer."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Verschaerfte Haftung 819 Bgb Bosglaeubigkeit"
  mike-type: "assistant"
