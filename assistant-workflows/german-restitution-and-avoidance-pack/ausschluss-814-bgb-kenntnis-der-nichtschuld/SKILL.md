...
description: "When Ausschluss nach Paragraf 814 BGB — Kenntnis der Nichtschuld in Restitution and Avoidance Law is required: checks deadline, form, jurisdiction, legal remedy, and immediate measures; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Ausschluss 814 Bgb Kenntnis Der Nichtschuld"
  mike-type: "assistant"
