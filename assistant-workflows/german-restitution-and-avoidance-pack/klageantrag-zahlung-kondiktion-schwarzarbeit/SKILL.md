...
description: "When Klageantrag: Zahlung, Herausgabe, Zug um Zug in Restitution and Avoidance Law is required: drafts the appropriate document from facts, norm, evidence, and motion; liefert einen verwertbaren Entwurf mit Anträgen, Begründung und Anlagenlogik. Auswahlstichwort: Klageantrag Zahlung Kondiktion Schwarzarbeit; Arbeitsfeld: bereicherungs-und-anfechtungsrecht-prüfer."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Klageantrag Zahlung Kondiktion Schwarzarbeit"
  mike-type: "assistant"
