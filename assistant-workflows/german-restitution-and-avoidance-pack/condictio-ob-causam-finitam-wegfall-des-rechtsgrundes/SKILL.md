...
description: "When Condictio ob causam finitam: Wegfall des Rechtsgrundes in Restitution and Avoidance Law is required: calculates thresholds, amounts, variants, and control assumptions; liefert eine Berechnungstabelle mit Schwellen, Annahmen und Kontrollfragen. Auswahlstichwort: Condictio Ob Causam Finitam Wegfall Des Rechtsgrundes; Arbeitsfeld: bereicherungs-und-anfechtungsrecht-prüfer."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Condictio Ob Causam Finitam Wegfall Des Rechtsgrundes"
  mike-type: "assistant"
