---
name: "gr-workflow-fristen-und-risikoampel"
description: "When Workflow Fristen Und Risikoampel in Intellectual Property is required: drafts the appropriate document from facts, norm, evidence, and motion; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Gr Workflow Fristen Und Risikoampel"
  mike-type: "assistant"
