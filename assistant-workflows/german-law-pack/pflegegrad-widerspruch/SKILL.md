...
description: "When Mandant erhielt zu niedrigen Pflegegrad oder Pflegekasse verweigert Pflegegrad in Social Security Law is required: checks deadline, form, jurisdiction, legal remedy, and immediate measures; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Pflegegrad Widerspruch"
  mike-type: "assistant"
