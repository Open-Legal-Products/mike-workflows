---
name: "insv-einstieg-routing"
description: "When Einstieg und Routing in Insolvenzverwaltung - IV-Cockpit is required: clarifies role, objective, deadline, documents, and the appropriate next specialist workflow; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Insv Einstieg Routing"
  mike-type: "assistant"
