...
description: "When Verfahrenswahl und Routenentscheidung in Insolvenzplan- und StaRUG-Planwerkstatt is required: calculates thresholds, amounts, variants, and control assumptions; produces a calculation table with thresholds, assumptions, and control questions."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Verfahrenswahl Restrukturierungsplan"
  mike-type: "assistant"
