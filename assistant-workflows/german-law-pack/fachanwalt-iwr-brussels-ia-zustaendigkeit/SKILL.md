...
description: "When Brüssel-Ia-VO Internationale Zuständigkeit in International Business Law is required: drafts the appropriate document from facts, norm, evidence, and motion; produces a usable draft with motions, reasoning, and exhibit logic."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Fachanwalt Iwr Brussels Ia Zustaendigkeit"
  mike-type: "assistant"
