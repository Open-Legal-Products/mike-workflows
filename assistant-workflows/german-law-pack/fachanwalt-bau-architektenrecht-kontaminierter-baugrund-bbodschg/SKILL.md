...
description: "When Kontaminierter Baugrund — Werkvertrag + BBodSchG-Sanierungspflicht in Construction and Architects Law is required: checks deadline, form, jurisdiction, legal remedy, and immediate measures; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Fachanwalt Bau Architektenrecht Kontaminierter Baugrund Bbodschg"
  mike-type: "assistant"
