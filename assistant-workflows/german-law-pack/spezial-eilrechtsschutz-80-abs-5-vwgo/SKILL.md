...
description: "When Eilrechtsschutz nach Paragraf 80 Abs. 5 VwGO in Administrative Law is required: checks deadline, form, jurisdiction, legal remedy, and immediate measures; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Spezial Eilrechtsschutz 80 Abs 5 Vwgo"
  mike-type: "assistant"
