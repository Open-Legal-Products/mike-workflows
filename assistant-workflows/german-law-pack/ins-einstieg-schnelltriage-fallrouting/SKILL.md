---
name: "ins-einstieg-schnelltriage-fallrouting"
description: "When Einstieg, Schnelltriage und Fallrouting in Fachanwalt Insolvenz Sanierungsrecht in Fachanwalt Insolvenz- und Sanierungsrecht is required: clarifies role, objective, deadline, documents, and the appropriate next specialist workflow; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Ins Einstieg Schnelltriage Fallrouting"
  mike-type: "assistant"
