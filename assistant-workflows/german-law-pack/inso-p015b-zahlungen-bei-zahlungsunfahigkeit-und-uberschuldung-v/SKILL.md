...
description: "When Paragraf 15b InsO (Zahlungen bei Zahlungsunfähigkeit und Überschuldung in Fachanwalt Insolvenz- und Sanierungsrecht is required: checks deadline, form, jurisdiction, legal remedy, and immediate measures; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Inso P015b Zahlungen Bei Zahlungsunfahigkeit Und Uberschuldung V"
  mike-type: "assistant"
