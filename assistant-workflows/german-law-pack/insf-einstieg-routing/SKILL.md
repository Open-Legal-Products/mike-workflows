---
name: "insf-einstieg-routing"
description: "When Einstieg und Routing in Insolvenzforderungsanmeldungsprüfung is required: clarifies role, objective, deadline, documents, and the appropriate next specialist workflow; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Insf Einstieg Routing"
  mike-type: "assistant"
