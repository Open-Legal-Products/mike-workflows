---
name: "red-team-plan"
description: "When Red Team Plan in Verbraucherinsolvenz und Schuldenbereinigung is required: drafts the appropriate document from facts, norm, evidence, and motion; produces a counter-check with error, evidence, and deadline review."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Red Team Plan"
  mike-type: "assistant"
