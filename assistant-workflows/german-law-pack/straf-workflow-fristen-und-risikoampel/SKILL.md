---
name: "straf-workflow-fristen-und-risikoampel"
description: "When Fristen- und Risikoampel in Criminal Law is required: checks deadline, form, jurisdiction, legal remedy, and immediate measures; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Straf Workflow Fristen Und Risikoampel"
  mike-type: "assistant"
