...
description: "When Architektenhonorar Hoai Mindestsatz EuGH C 377 17 in Construction and Architects Law is required: checks deadline, form, jurisdiction, legal remedy, and immediate measures; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Architektenhonorar Hoai Mindestsatz Eugh C 377 17"
  mike-type: "assistant"
