---
name: "hgr-workflow-mandantenkommunikation"
description: "When Mandantenkommunikation in Fachanwalt Handels- und Gesellschaftsrecht is required: checks deadline, form, jurisdiction, legal remedy, and immediate measures; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Hgr Workflow Mandantenkommunikation"
  mike-type: "assistant"
...
- **Mandantengeheimnis und KI-Tools:** Offene Chatbots im Web sind ohne Auftragsverarbeitungsvertrag nicht DSGVO-konform für Mandantendaten. Lieber lokale Lösungen oder Tools mit AVV.
