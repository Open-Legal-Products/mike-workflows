...
description: "When Europarecht: Fristen, Form, Zuständigkeit und Rechtsweg in Subsumtions-Prüfer is required: checks deadline, form, jurisdiction, legal remedy, and immediate measures; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Europarecht Fristen Form Und Zustaendigkeit"
  mike-type: "assistant"
