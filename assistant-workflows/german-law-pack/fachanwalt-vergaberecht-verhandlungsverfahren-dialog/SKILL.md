...
description: "When Verhandlungsverfahren und wettbewerblicher Dialog in Public Procurement Law is required: develops negotiation objective, settlement corridor, and escalation path; produces a negotiation or escalation line with options."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Fachanwalt Vergaberecht Verhandlungsverfahren Dialog"
  mike-type: "assistant"
