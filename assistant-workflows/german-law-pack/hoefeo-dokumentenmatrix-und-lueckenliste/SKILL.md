...
description: "When Hoefeo: Dokumentenmatrix, Lückenliste und Nachforderung in Agricultural Law is required: organises file content, evidence, gaps, and follow-up requests; produces a document matrix with a follow-up request list."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Hoefeo Dokumentenmatrix Und Lueckenliste"
  mike-type: "assistant"
