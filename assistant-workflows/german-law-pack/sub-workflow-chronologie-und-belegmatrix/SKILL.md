---
name: "sub-workflow-chronologie-und-belegmatrix"
description: "When Chronologie und Belegmatrix für Subsumtion in Subsumtions-Prüfer is required: organises file content, evidence, gaps, and follow-up requests; produces a chronology with evidence matrix and objection list."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Sub Workflow Chronologie Und Belegmatrix"
  mike-type: "assistant"
