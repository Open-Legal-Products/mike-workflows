---
name: "iwr-anschluss-routing"
description: "When Anschluss-Routing in International Business Law is required: clarifies role, objective, deadline, documents, and the appropriate next specialist workflow; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Iwr Anschluss Routing"
  mike-type: "assistant"
