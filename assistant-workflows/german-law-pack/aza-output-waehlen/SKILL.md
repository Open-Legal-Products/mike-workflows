---
name: "aza-output-waehlen"
description: "When Output wählen in Arbeitszeugnis-Analyse is required: drafts the appropriate document from facts, norm, evidence, and motion; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Aza Output Waehlen"
  mike-type: "assistant"
