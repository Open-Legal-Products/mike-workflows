...
description: "When Bankrecht Kaufmaennische Buergschaft HGB 349 350 in Banking and Capital Markets is required: drafts the appropriate document from facts, norm, evidence, and motion; produces a usable draft with motions, reasoning, and exhibit logic."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Bankrecht Kaufmaennische Buergschaft Hgb 349 350"
  mike-type: "assistant"
