...
description: "When Verfahrens: Behörden-, Gerichts- oder Registerweg in Migration Law is required: checks deadline, form, jurisdiction, legal remedy, and immediate measures; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Verfahrens Behoerden Gericht Und Registerweg"
  mike-type: "assistant"
