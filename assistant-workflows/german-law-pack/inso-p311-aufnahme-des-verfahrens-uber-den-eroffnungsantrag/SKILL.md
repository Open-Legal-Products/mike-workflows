...
description: "When Inso P311 Aufnahme Des Verfahrens Uber Den Eroffnungsantrag in Fachanwalt Insolvenz- und Sanierungsrecht is required: drafts the appropriate document from facts, norm, evidence, and motion; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Inso P311 Aufnahme Des Verfahrens Uber Den Eroffnungsantrag"
  mike-type: "assistant"
