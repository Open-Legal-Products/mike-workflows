...
description: "When Bereichs-Drift-Detektor (Schaufenster-Pattern) in Arbeitszeugnis-Analyse is required: organises facts, norm, burden of proof, counter-arguments, and next step; produces an interface map with conflict, jurisdiction, and evidence questions."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Bereichs Drift Detektor"
  mike-type: "assistant"
