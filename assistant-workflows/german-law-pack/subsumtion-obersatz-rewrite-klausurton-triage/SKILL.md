...
description: "When Subsumtion: Obersatz – Definition – Untersatz – Ergebnis in Subsumtions-Prüfer is required: clarifies role, objective, deadline, documents, and the appropriate next specialist workflow; produces an element-of-offence or claim matrix with counter-arguments."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
