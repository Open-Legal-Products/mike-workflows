---
name: "hgr-einstieg-schnelltriage-fallrouting"
description: "When Einstieg, Schnelltriage und Fallrouting in Fachanwalt Handels Gesellschaftsrecht in Fachanwalt Handels- und Gesellschaftsrecht is required: clarifies role, objective, deadline, documents, and the appropriate next specialist workflow; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Hgr Einstieg Schnelltriage Fallrouting"
  mike-type: "assistant"
