...
description: "When Master-Routing-Skill der sozialrechtlichen Kanzlei in Social Security Law is required: clarifies role, objective, deadline, documents, and the appropriate next specialist workflow; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Sozialrecht Fallaufnahme Routing"
  mike-type: "assistant"
