...
description: "When Anlagen: Mehrparteienkonflikt und Interessenmatrix in Insolvenzplan- und StaRUG-Planwerkstatt is required: checks deadline, form, jurisdiction, legal remedy, and immediate measures; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Anlagen Mehrparteien Konflikt Und Interessen"
  mike-type: "assistant"
