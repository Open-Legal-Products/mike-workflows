...
description: "When Pflichtteilsergaenzung Frist Naechster Schritt in Inheritance Law is required: checks deadline, form, jurisdiction, legal remedy, and immediate measures; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Pflichtteilsergaenzung Frist Naechster Schritt"
  mike-type: "assistant"
