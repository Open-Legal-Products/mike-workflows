...
description: "When Ersteinordnung neuer Mandate im Transport- und Speditionsrecht: Vertragstyp, national vs in Transport and Freight Forwarding Law is required: clarifies role, objective, deadline, documents, and the appropriate next specialist workflow; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Mandat Triage Transport Speditionsrecht"
  mike-type: "assistant"
