...
description: "When Interaktiv: Erstprüfung, Rollenklärung und Mandatsziel in Subsumtions-Prüfer is required: clarifies role, objective, deadline, documents, and the appropriate next specialist workflow; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Interaktiver Erstpruefung Und Mandatsziel"
  mike-type: "assistant"
