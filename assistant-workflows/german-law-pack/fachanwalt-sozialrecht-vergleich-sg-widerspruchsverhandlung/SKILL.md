...
description: "When Sozialrecht — Vergleich vor SG / Widerspruchsverhandlung in Social Security Law is required: develops negotiation objective, settlement corridor, and escalation path; produces a negotiation or escalation line with options."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Fachanwalt Sozialrecht Vergleich Sg Widerspruchsverhandlung"
  mike-type: "assistant"
