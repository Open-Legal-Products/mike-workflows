...
description: "When Laienverstaendlicher Sozialrechts-Skill zu Merkzeichen in Social Security Law is required: drafts the appropriate document from facts, norm, evidence, and motion; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Laienhilfe Merkzeichen"
  mike-type: "assistant"
