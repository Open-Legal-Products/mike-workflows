...
description: "When Untätigkeitsklage in Migration Law is required: drafts the appropriate document from facts, norm, evidence, and motion; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Spezial Untatigkeitsklage"
  mike-type: "assistant"
