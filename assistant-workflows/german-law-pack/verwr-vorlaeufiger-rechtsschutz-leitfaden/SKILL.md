...
description: "When Leitfaden vorläufiger Rechtsschutz VwGO: Paragraf 80 Abs in Administrative Law is required: drafts the appropriate document from facts, norm, evidence, and motion; produces a usable draft with motions, reasoning, and exhibit logic."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Verwr Vorlaeufiger Rechtsschutz Leitfaden"
  mike-type: "assistant"
