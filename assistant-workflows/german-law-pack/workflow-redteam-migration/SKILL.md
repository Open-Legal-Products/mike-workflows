...
description: "When Red-Team Migration: Prüfungslinie für Migrationsrecht in Migration Law is required: decomposes outcome, deadline, jurisdiction, burden of proof, and opposing position; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Workflow Redteam Migration"
  mike-type: "assistant"
