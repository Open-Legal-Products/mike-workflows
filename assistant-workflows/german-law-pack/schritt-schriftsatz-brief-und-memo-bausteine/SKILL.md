...
description: "When Schriftsatz-, Brief- und Memo-Bausteine in Subsumtions-Prüfer is required: drafts the appropriate document from facts, norm, evidence, and motion; produces a usable draft with motions, reasoning, and exhibit logic."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Schritt Schriftsatz Brief Und Memo Bausteine"
  mike-type: "assistant"
