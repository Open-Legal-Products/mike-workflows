---
name: "erb-einstieg-routing"
description: "When Anwalts-Dashboard Fachanwalt Erbrecht in Inheritance Law is required: clarifies role, objective, deadline, documents, and the appropriate next specialist workflow; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Erb Einstieg Routing"
  mike-type: "assistant"
