...
description: "When Laienverstaendlicher Sozialrechts-Skill zu Sanktion Minderung in Social Security Law is required: checks deadline, form, jurisdiction, legal remedy, and immediate measures; produces a deadline and risk indicator with immediate action steps."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
  language: "German"
  mike-display-name: "Laienhilfe Sanktion Minderung"
  mike-type: "assistant"
