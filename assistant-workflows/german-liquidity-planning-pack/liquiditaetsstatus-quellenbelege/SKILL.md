...
description: "When Liquiditätsstatus nur aus belastbaren Quellenbelegen in Insolvency and Restructuring Law is required: organises file content, evidence, gaps, and follow-up requests; produces an interface map with conflict, jurisdiction, and evidence questions."
license: "MIT"
metadata:
  version: "1.0.0"
  author: "Klotzkette"
